...
def data_over_time(df,col):
    ...
    nations_over_time.columns = ['Edition', col]  # Rename columns for clarity
...
def most_successful(df, sport):
    ...
    #print(x.head())  # Debug: Check the structure of x after reset_index
    x.columns = ['Name', 'Count']

    x = x.merge(df, on='Name', how='left')
    #print(x.head())  # Debug: Check the structure of x after merge
